    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.profileSection}>
		...
		{/* <TouchableWithoutFeedback onPress={() => console.log("Change profile image")}>
          ...
          <Text style={{ fontSize: 18, fontWeight: "bold" }}>Followers: 1000</Text>
          <Text style={{ fontSize: 18, fontWeight: "bold" }}>Following: 0</Text>
          <Text style={{ fontSize: 18, fontWeight: "bold" }}>Posts: 50</Text>
        </View>
      </View>
