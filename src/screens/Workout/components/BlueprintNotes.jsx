...
const BlueprintNotes = () => {
	...
	useEffect(() => {
		if (modalVisible) {
			setTempNotes(blueprintNotes);
		}
	}, [modalVisible]);

	const handleblueprintNotesChange = (text) => {
		setTempNotes(text);
	};
				...
				<View style={{ flex: 1, alignItems: "center" }}>
					...
					<View style={styles.modalView}>
						<View style={styles.modalHeader}>
							<Text style={styles.modalTitle}>Blueprint Notes</Text>
							<TouchableOpacity
								onPress={cancelNotes}
						...
						<View style={styles.inputContainer}>
							<TextInput
								...
								placeholder="Add blueprint notes..."
								placeholderTextColor={
									themeStyle.textColorSecondary
								}
								value={tempNotes}
								onChangeText={handleblueprintNotesChange}
								multiline
